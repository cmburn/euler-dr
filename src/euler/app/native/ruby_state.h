...
public:
	...
	RClass *define_class_under(RClass *outer, const char *name, RClass *super) override;
	void define_module_function(RClass *cla, const char *name, mrb_func_t fun, mrb_aspec aspec) override;
	void define_method(RClass *cla, const char *name, mrb_func_t func, mrb_aspec aspec) override;
	void define_class_method(RClass *cla, const char *name, mrb_func_t fun, mrb_aspec aspec) override;
	mrb_int get_args(mrb_args_format format, ...) override;
	mrb_value str_new_cstr(const char *) override;
	RData *data_object_alloc(RClass *klass, void *datap, const mrb_data_type *type) override;
	...
	RClass *define_class_under_id(RClass *outer, mrb_sym name, RClass *super) override;
	...
	RProc *proc_new_cfunc_with_env(mrb_func_t func, mrb_int argc, const mrb_value *argv) override;
	...
	const char *debug_get_filename(const mrb_irep *irep, uint32_t pc) override;
	...
	enum mrb_range_beg_len range_beg_len(mrb_value range, mrb_int *begp, mrb_int *lenp, mrb_int len, mrb_bool trunc) override;
	int float_to_cstr(char *buf, size_t len, const char *fmt, mrb_float f) override;
	...
	mrb_bool func_basic_p(mrb_value obj, mrb_sym mid, mrb_func_t func) override;
	...
	mrb_int str_index(mrb_value str, const char *p, mrb_int len, mrb_int offset) override;
	...
	mrb_irep_debug_info_file *debug_info_append_file(mrb_irep_debug_info *info, const char *filename, uint16_t *lines, uint32_t start_pos, uint32_t end_pos) override;
	...
	mrb_parser_state *parse_nstring(const char *, size_t, mrb_ccontext *) override;
	...
	mrb_value ary_new_from_values(mrb_int size, const mrb_value *vals) override;
	...
	mrb_value ary_splice(mrb_value self, mrb_int head, mrb_int len, mrb_value rpl) override;
	...
	mrb_value cstr_to_inum(const char *s, mrb_int base, mrb_bool badcheck) override;
	mrb_value cv_get(mrb_value mod, mrb_sym sym) override;
	mrb_value ensure(mrb_func_t body, mrb_value b_data, mrb_func_t ensure, mrb_value e_data) override;
	...
	mrb_value fiber_resume(mrb_value fib, mrb_int argc, const mrb_value *argv) override;
	...
	mrb_value funcall(mrb_value val, const char *name, mrb_int argc, ...) override;
	mrb_value funcall_argv(mrb_value val, mrb_sym name, mrb_int argc, const mrb_value *argv) override;
	mrb_value funcall_id(mrb_value val, mrb_sym mid, mrb_int argc, ...) override;
	mrb_value funcall_with_block(mrb_value val, mrb_sym name, mrb_int argc, const mrb_value *argv, mrb_value block) override;
	...
	mrb_value hash_fetch(mrb_value hash, mrb_value key, mrb_value def) override;
	...
	mrb_value load_irep_buf_cxt(const void *, size_t, mrb_ccontext *) override;
	...
	mrb_value load_nstring_cxt(const char *s, size_t len, mrb_ccontext *cxt) override;
	...
	mrb_value obj_new(RClass *c, mrb_int argc, const mrb_value *argv) override;
	mrb_value obj_value(void *p) override;
	mrb_value proc_cfunc_env_get(mrb_int idx) override;
	mrb_value protect(mrb_func_t body, mrb_value data, mrb_bool *state) override;
	mrb_value ptr_to_str(void *p) override;
	mrb_value range_new(mrb_value start, mrb_value end, mrb_bool exclude) override;
	mrb_value rescue(mrb_func_t body, mrb_value b_data, mrb_func_t rescue, mrb_value r_data) override;
	mrb_value rescue_exceptions(mrb_func_t body, mrb_value b_data, mrb_func_t rescue, mrb_value r_data, mrb_int len, RClass **classes) override;
	...
	mrb_value str_to_integer(mrb_value str, mrb_int base, mrb_bool badcheck) override;
	...
	mrb_value top_run(const RProc *proc, mrb_value self, mrb_int stack_keep) override;
	mrb_value top_self() override;
	mrb_value type_convert(mrb_value val, mrb_vtype type, mrb_sym method) override;
	mrb_value type_convert_check(mrb_value val, mrb_vtype type, mrb_sym method) override;
	...
	mrb_value vm_run(const RProc *proc, mrb_value self, mrb_int stack_keep) override;
	...
	mrb_value yield_argv(mrb_value b, mrb_int argc, const mrb_value *argv) override;
	mrb_value yield_with_class(mrb_value b, mrb_int argc,const mrb_value *argv, mrb_value self, RClass *c) override;
	...
	void define_class_method_id(RClass *cla, mrb_sym name, mrb_func_t fun, mrb_aspec aspec) override;
	void define_const(RClass *cla, const char *name, mrb_value val) override;
	...
	void define_method_id(RClass *c, mrb_sym mid, mrb_func_t func, mrb_aspec aspec) override;
	void define_method_raw(RClass *, mrb_sym, mrb_method_t) override;
	void define_module_function_id(RClass *cla, mrb_sym name, mrb_func_t fun, mrb_aspec aspec) override;
	void define_singleton_method(RObject *cla, const char *name, mrb_func_t fun, mrb_aspec aspec) override;
	void define_singleton_method_id(RObject *cla, mrb_sym name, mrb_func_t fun, mrb_aspec aspec) override;
	...
	void hash_foreach(RHash *hash, mrb_hash_foreach_func *func, void *p) override;
	...
	void iv_foreach(mrb_value obj, mrb_iv_foreach_func *func, void *p) override;
	...
	void no_method_error(mrb_sym id, mrb_value args, const char *fmt, ...) override;
